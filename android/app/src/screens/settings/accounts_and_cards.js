    ...
    handleBackButton = () => {
        if (this.props.isFocused) {
            if (this.state.show_delete_dialog) {
                ...
                !this.state.deleting && !this.props.loading && this.props.navigation.goBack();
            }
    ...
    render() {
        ...
        return (
            <View style={SharedStyle.mainContainer}>
                <MainHeader leftIcon="arrow-left" onPressLeftIcon={this.handleBackButton} title={Dictionary.ACCOUNTS_AND_CARDS_HEADER} />
                    ...
                    {!this.state.deleting && !this.props.loading && (
                        <View>
                            <View style={styles.summary}>
                                <Text style={[styles.text, styles.summaryText]}>{cardCountText}</Text>
                                <TouchItem
                                    ...
                                    {this.props.payment.cards.map((card, index) => {
                                        ...
                                        return <LinearGradient
                                            ...
                                            <View style={styles.cardTop}>
                                                ...
                                                />
                                                <TouchItem style={styles.cardAction} onPress={() => this.deleteCard(card)}>
                                            ...
                                            <View style={styles.cardBottom}>
                                                <View style={styles.halfColumn}>
                                                    <Text numberOfLines={1} style={[styles.text, styles.label]}>{Dictionary.CARD_NUMBER_LABEL}</Text>
                                                    <Text numberOfLines={1} style={[styles.text, styles.value]}>
                                                        <Text style={styles.mask}>XXXX</Text> <Text>{card.lastFourDigit}</Text>
                                                    </Text>
                                                </View>
                                                <View style={styles.halfColumn}>
                                                    <Text numberOfLines={1} style={[styles.text, styles.label, styles.right]}>{Dictionary.CARD_EXP_LABEL}</Text>
                                                    <Text numberOfLines={1} style={[styles.text, styles.value, styles.right]}>{expiry}</Text>
                                                </View>
                                            </View>
                                        </LinearGradient>
                                    })}
                ...
                <Modal
                    ...
                    <View style={styles.dialog}>
                        ...
                        <View style={styles.modalContainer}>
                            ...
                            <Text numberOfLines={2} style={styles.message}>{this.state.delete_message}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigationFocus(AccountsAndCards));