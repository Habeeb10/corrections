                            ...
                            <View>
                                ...
                                <View style={styles.breakdown}>
                                    <View style={SharedStyle.row}>
                                        ...
                                        <View style={SharedStyle.halfColumn}>
                                            <Text numberOfLines={1} style={[SharedStyle.normalText, SharedStyle.label, SharedStyle.right]}>{`Interest (${breakdown.interest_rate}% ${Dictionary.PER_ANNUM})`}</Text>
                                    ...
                                    <View style={SharedStyle.row}>
                                        <View style={SharedStyle.halfColumn}>
                                            ...
                                            <Text numberOfLines={2} style={[styles.value]}>
                                                ₦{Util.formatAmount(breakdown.withholding_tax)} / {breakdown.withholding_tax_rate}{Dictionary.PERCENT_OF_INTEREST}
                                            </Text>
                                        </View>
                                        <View style={SharedStyle.halfColumn}>
                                            <Text numberOfLines={1} style={[SharedStyle.normalText, SharedStyle.label, SharedStyle.right]}>{Dictionary.MATURITY_AMOUNT}</Text>
                                            <Text numberOfLines={2} style={[styles.value, SharedStyle.right]}>₦{Util.formatAmount(breakdown.maturity_value - breakdown.withholding_tax)}</Text>
                                        </View>
                                    </View>
                                </View>
