...
export const TOUR_ONE_DESCRIPTION = 'Creditville offers you loans with zero\ncollateral and documentations';
export const TOUR_TWO_TITLE = 'Grow your funds with up to\n12% interest per annum';
export const TOUR_TWO_DESCRIPTION = 'Creditville lets you save and earn\ninterest without lifting a finger.';
export const TOUR_THREE_TITLE = 'Pay your everyday\nbills with ease.';
export const TOUR_THREE_DESCRIPTION = 'Get quick access to pay all your bills\ndirectly from your bank account.';
...
export const COMMING_SOON_CLICK = 'This module is comming soon!';
...
export const ENTER_OTP_BVN = 'Enter the 6 digit code sent to your bvn phone number';
...
export const NEW_PIN_LABEL = 'Enter a new New PIN';
...
export const RESIDENCE_ADDRESS_LABEL = 'What is your current place of residence?';
...
export const YOUR_EMPLOYMENT_STATUS_LABEL = 'What\'s your current employment status?';
...
export const YOUR_EMPLOYMENT_DURATION_LABEL = 'How long have you been in paid employment?';
...
export const ACCOUNTS_AND_CARDS_HEADER = 'Banks Accounts & Cards';
...
export const BILL_PAYMENT_HEADER = 'Paying bills has never been easier';
...
export const SIGN_UP_ENTER_MOBILE_HEADER = 'Let\'s get started with your preferred mobile number.';
export const SYSTEM_UPGRADE_VERIFY_PHONE_NUMBER = 'Please verify your phone Number';
export const SIGN_UP_VALIDATE_MOBILE_HEADER = 'Kindly verify your number with the OTP you just received.';
export const SIGN_UP_CREATE_PASSWORD_HEADER = 'Your security is Key! Kindly set a strong password here.';
export const SIGN_UP_CREATE_CUSTOMER_HEADER = 'Please Enter your info to create account.';
export const SIGN_UP_ENTER_BVN_HEADER = 'Please enter your BVN.';
export const SIGN_UP_VALIDATE_BVN_HEADER = 'Hello %s, please confirm that these BVN details are yours';
export const SIGN_UP_UPLOAD_UTILITY_HEADER = 'Please upload a recent utility bill';
export const SIGN_UP_CREATE_PIN_HEADER = 'Finally, secure your transactions with a safe Authorization PIN';
export const FORGOT_ENTER_MOBILE_HEADER = 'Please enter your mobile number to recover your password';
export const VALIDATE_MOBILE_HEADER = 'Please enter the OTP that was sent to your number';
export const CHANGE_PASSWORD_SUB_HEADER = 'Set a password you won\'t easily forget';
...
export const ADD_CARD_SUB_HEADER = 'We help you automate your savings using your debit card';
export const ADD_ACCOUNT_SUB_HEADER = 'Link your bank accounts for withdrawals';
export const NEXT_OF_KIN_SUB_HEADER = 'We will contact your next of kin if we are not able to reach you. Your next of kin should be someone very close to you or trusted';
export const ONBOARD_EMAIL_HEADER = 'We will keep you informed at all times with our emails.';
...
export const APPLY_FOR_LOAN_SUB_HEADER = 'Quick access to funds for all your emergency needs.';
export const LOAN_REQUIREMENTS_HEADER = 'We need few information to process your loan';
...
export const LOAN_PERSONAL_DETAILS_HEADER = 'Please share your personal information with us.';
export const LOAN_EMPLOYMENT_DETAILS_HEADER = 'Please share your education and employment information with us.';
...
export const GUARANTOR_HEADER = 'One more thing, who can we call if we can\'t reach you?';
export const NUMBER_TO_BUY_FOR_SUB_HEADER = 'What number are you buying for?';
export const NETWORK_TO_BUY_FOR_SUB_HEADER = 'What network is the number registered with?';
export const AIRTIME_AMOUNT_SUB_HEADER = 'How much airtime are you buying?';
export const BILL_PAYMENT_SUB_HEADER = 'We can help you pay bills with ease.';
...
export const FUNDS_TRANSFER_SUB_HEADER = 'We can help you send money with ease.';
...
export const FUND_WALLET_SUB_HEADER = 'How would you like to fund your account?';
...
export const SAVINGS_WITHDRAWAL_SUB_HEADER = 'How much do you want to withdraw?';
...
export const CV_LIMITED = 'CREDITVILLE LIMITED';
...
export const BIOMETRIC_LOGIN_DESCRIPTION = 'This app will use the biometric data saved on this device to log you in.';
export const BIOMETRIC_TRANSACTION_TITLE = 'Transactions with Biometrics';
export const BIOMETRIC_TRANSACTION_DESCRIPTION = 'This app will use the biometric data saved on this device to authorize transactions.';
export const APP_NOTIFICATIONS_TITLE = 'In-app Notifications';
export const APP_NOTIFICATIONS_DESCRIPTION = 'This app will turn off your notifications.\nYou wll not receive any update if off.';
export const DOCUMENT_UPLOADED = 'Document uploaded successfully';
export const CONFIRM_DELETE_CARD = 'Delete %s card ending %s from your profile?';
...
// LOCAL ERRORS
export const SESSION_EXPIRED_TITLE = 'Expired Session';
export const SESSION_EXPIRED_MSG = 'Oops! Your session has expired. Please login again to continue';
...
export const OTP_EMPTY_ERROR = 'Please enter the six digit otp sent to your phone number';
...
export const NETWORK_ERROR = 'Oops... It seems you have lost your internet connection.';
export const CAMERA_STORAGE_PERMISSION_ERROR = 'Camera and storage permissions are required';
export const STORAGE_PERMISSION_ERROR = 'Storage permission is required';
export const BVN_MOBILE_MISMATCH = 'Doesn\'t match the mobile number registered on your BVN.';
export const CYCLIC_PASSWORD_CHANGE = 'Your current and new password should not be the same.';
export const CYCLIC_PIN_CHANGE = 'Your current and new PIN should not be the same.';
...
export const GENERAL_ERROR = 'An unexpected error has occured. Please try again later.';
export const OFFLINE_NOTICE = 'Looks like there\'s a problem. Check your internet connection';
export const SIGN_UP_TERMS = 'By proceeding with your mobile number, you agree to';
export const OTP_SENT = 'OTP has been sent successfully';
export const AUTHORIZE_DEVICE_SUCCESS = 'Device authorize successfully';

export const BVN_POLICY = 'BVN Privacy';
export const BVN_POLICY_TEXT = 'BVN is a requirement by CBN\nfor customer verification.\nYour BVN does not give us access to your account, we can only access your Fullname, Mobile Number and Date of Birth.';
export const ENTER_MOBILE_LAST_5 = 'Enter the last 5 digits of your mobile number which starts with %s';
export const ENTER_BVN_DATE = 'Ensure your date of birth is as you have it on your BVN.';
export const ID_REQUIRED = 'ID Required';
export const ID_REQUIREMENTS = '- International Passport\n- Drivers License\n- National Identification Card\n- Voters Card';
...
export const RESET_COMPLETE = 'Your new password is set';
export const RESET = 'Reset';
export const CONFIRM = 'Confirm';
export const EXIT_APP = 'Do you want to exit the app?';
export const HI_USER = 'Hi %s';
export const CARD_COUNT = '%s Debit Cards';
export const ACCOUNT_COUNT = '%s Bank Accounts';
...
export const COMPLETE_ONBOARDING = 'You need to complete sign up to access this feature';
export const BLANK = ' ';
...
export const SESSION_TIMEOUT_MSG = 'Please click \'Continue\' to keep working or get \'Logged Out\' in ';
...
// WALLET
export const TRANSFER_TO_VIRTUAL_ACCOUNT = 'Transfer money to your account from any bank';
...
export const FUND_WITH_CREDITVILLE_BANK = 'Pay into Creditville account at any bank';
export const FUND_WITH_AGENT = 'Pay in at the nearest agent';
export const FUND_AMOUNT_HEADER = 'How much do you want to fund?';
...
export const AUTOMATE_YOUR_SAVINGS_DESCRIPTION = 'We\'ll use your debit card to fund your savings at the interval specified. Saving you the trouble of having to do it yourself.';
...
export const SET_SAVINGS_FREQUENCY = 'How frequently do you want to save on this plan?';
export const SAVINGS_PENALTY = 'Any withdrawal before the maturity date will attract a %s% penal charge on interest earned.';
export const WITHDRAWAL_PENALTY = 'There will be a %s% penal charge on interest earned if you proceed to make this withdrawal.';
...
export const SAVINGS_TOP_UP_SUMMARY = 'Please confirm your Savings Top-Up transaction';
...
export const ROLLOVER_PENALTY = 'This date will be the maturity date of this savings plan. Any withdrawal before this date will attract a %s% penal charge on interest earned.';
...
export const AMOUNT_RANGE = 'Minimum of ₦{{min_amount}} and a maximum of ₦{{max_amount}}';
export const LOCK_SAVINGS_TITLE = 'Note that your savings will be locked!';
export const LOCK_SAVINGS_DESSCRIPTION = 'Your savings will be locked for the duration of the savings and you will be unable to withdraw until maturity date.';
...
export const ARCHIVE_SAVINGS_DESSCRIPTION = 'Please note that you are about to archive your savings and it will not be displayed as part of your savings';
export const RESTORE_SAVINGS_TITLE = 'Restore savings';
export const RESTORE_SAVINGS_DESSCRIPTION = 'Please note that you are about to restore your savings and it will be displayed as part of your savings';
export const NO_ARCHIVE_VALUED_SAVINGS = 'You cannot archive this plan because you have funds in it';
...
export const PERSONAL_INFO_DESCRIPTION = 'We want to know you better. Please share some of your personal information with us.';
export const EMPLOYMENT_INFO_TITLE = 'Employment details';
export const EMPLOYMENT_INFO_DESCRIPTION = 'Trust work is great! Please share some information on your 9-5. We\'ll like to know more about you.';
export const DEBIT_CARD_INFO_TITLE = 'Functional Debit Card';
export const DEBIT_CARD_INFO_DESCRIPTION = 'We hate to stress you, we will like you to add a working debit card to ease your loan repayment.';
export const GUARANTOR_INFO_TITLE = 'A trusted contact information';
export const GUARANTOR_INFO_DESCRIPTION = 'We understand that you might be unreachable at times, but there\'s always someone that can help us with that.';
...
export const GET_HIGHER_LOANS = 'Get higher amounts up to ₦150,000 if you pay on time.';
export const DISCOUNTS = 'Discounts';
export const GET_DISCOUNTS = 'Get discounts when you pay early';
export const INSTALLMENTS = 'Installments';
export const SPREAD_INSTALLMENTS = 'You can get spread installments in the future.';
...
export const REPORTED_TO_CREDIT_BUREAUS = 'Defaulters are reported to Credit Burueaus';
export const EMPLOYMENT_HISTORY_SERVICE = 'Employment History Verification Service';
export const _VERIFY_ME = '(Verify Me)';
export const VERIFY = 'Verify';
export const REPORTED_TO_VERIFY_ME = 'Defaulters will be reported to the Verify Me Black List.';
...
export const LOAN_APPLICATION_SUCCESS = 'We have received your loan application. A verification email has been sent to your work email address, kindly check this to complete your request.';
...
export const LOCATION_ERROR = 'Unable to retrieve location. Make sure that location services are enabled.';
export const NO_LOAN_PRODUCTS = 'There are no loans available that meets your profile.';
...
export const TOTAL_SIGN_UPS = 'Total Signups';
export const TOTAL_EARNINGS = 'Total Earnings';
export const ACTIVITIES = 'Activities';
export const VIEW_MORE = 'View more';
export const NO_REFERRAL = 'Your friends are yet to use your link. If you haven\'t shared your link with friends, start sharing today!'
...
export const SHARE_LINK_ERROR = 'Unable to share link at this time. Please try again later';
...
export const SYSTEM_UPGRADE_TEXT = "We’ve optimized our app and would you love you to update your password so we can serve you better by folloowing the steps.";

export const ALMOST_DONE = "You’re almost done!!";
export const ALMOST_DONE_TEXT = "You’ve done a great job and its just remaining the last step which is changing your password and pin.";
export const SYSTEM_UPGRADE_CREATE_PIN_SUCCESS = "Pin Updated successfully.";
