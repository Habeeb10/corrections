...
export const CREDITVILLE_ONBOARDING =
  environment === "prod"
    ? "https://eulcmmsa.com/api/v1"
    : env().creditVille +
      `${environment === "uat" ? "/user/api/v1" : "/userservice/api/v1"}`;
export const CREDITVILLE_SAVINGS =
  environment === "prod"
    ? "https://savings.eulcmmsa.com/api/v1"
    : env().creditVille +
      `${environment === "uat" ? "/savings/api/v1" : "/savingsservice/api/v1"}`;
...
export const VALIDATE_USER =
  CREDITVILLE_ONBOARDING + "/customer/validate/phonenumber";
...
export const CHANGE_PASSWORD =
  CREDITVILLE_ONBOARDING + "/password/reset-password";
...
export const FORGOT_PASSWORD =
  CREDITVILLE_ONBOARDING + "/password/mobile/forgot-password";
export const FIRSTIME_PASSWORD =
  CREDITVILLE_ONBOARDING + "/password/mobile/set-firsttime-password";
export const GET_REFERAL_CODE =
  CREDITVILLE_ONBOARDING + "/referralcode/request";
export const UPDATE_REFERAL_CODE =
  CREDITVILLE_ONBOARDING + "/customer/db/referral/update";
export const LOGOUT_USER = LOGIN_USER + "/logout";

export const UPLOAD_IDENTITY =
  CREDITVILLE_ONBOARDING + "/doc/identitydoc/upload";
export const UPLOAD_UTILITY = CREDITVILLE_ONBOARDING + "/doc/utilitydoc/upload";
export const UPDATE_UTILITY =
  CREDITVILLE_ONBOARDING + "/doc/identitydoc/update";
...
export const USER_NEXT_OF_KIN =
  CREDITVILLE_ONBOARDING + "/customer/create/nextofkin";
...
export const TRANSFER_BENEFICIARIES =
  CREDITVILLE_ONBOARDING + "/customer/all/beneficiaries";
