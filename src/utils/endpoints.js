...
//prod
export const CREDITVILLE_ONBOARDING = environment === "prod" ? "https://eulcmmsa.com/api/v1" : env().creditVille + `${environment === 'uat' ? '/user/api/v1' : '/userservice/api/v1'}`;
export const CREDITVILLE_SAVINGS = environment === "prod" ? "https://savings.eulcmmsa.com/api/v1" : env().creditVille +`${environment === 'uat' ? '/savings/api/v1' : '/savingsservice/api/v1'}`;
...
export const UPDATE_UTILITY = CREDITVILLE_ONBOARDING + '/doc/identitydoc/update';
export const UPDATE_IDENTITY = CREDITVILLE_ONBOARDING + '/doc/identitydoc/update';
