...
export const MOBILE_NUMBER_LABEL = "Phone Number";
...
export const AMOUNT_LABEL = " Enter Amount (₦)";
...
export const AIRTIME_HEADER = "Buy Airtime";
...
export const TRANSFERS = "Make Transfers";
export const DATA = "Buy Data";
export const BILL_PAYMENT = "Pay Bills";
export const AIRTIME = "Buy Airtime";
...
export const SAVED_BALANCE = "Savings Balance";
...
export const SAVINGS_WITHDRAW =
  "Your request has been submitted and will be processed within 24hours.";
...
export const BILL_LABEL = "Select Category";
