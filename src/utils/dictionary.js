...
export const FUNDS_TRANSFER_SUB_HEADER = 'We can help you send money seamlessly.';
...
export const SESSION_EXPIRED_MSG = 'Oops! You are unauthorized. Please login again to continue';
...
export const FUND_AMOUNT_HEADER = 'How much do you want to fund your account with?';
...
export const NO_REFERRAL = 'Your friends are yet to use your link. If you haven\'t shared your link with them, start sharing today!'
...
export const SYSTEM_UPGRADE_TEXT = "We’ve optimized our App to serve you better. Please update your Password and PIN to access the C Money App. Kindly follow these easy steps below.";

export const ALMOST_DONE = "You’re almost done!!";
export const ALMOST_DONE_TEXT = "Great job so far, we are just left with the last step, which is changing your Password and PIN.";
