...
class BillsCategory extends Component {
    ...
    render() {
        let categories=this.state.categories.filter(item=>item.slug!="data_bundle"&& item.slug!="airtime")
        return (
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigationFocus(BillsCategory));