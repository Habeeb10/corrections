            ...
            <View style={SharedStyle.mainContainer}>
                ...
                <ScrollView {...this.props} hasButtomButtons={true}>
                    ...
                    <View style={styles.accountypeContainerStyle}>
                        ...
                        <AccountTypeButton isActive={this.state.isIntra} onPress={()=>{this.onChangeAccountType(account_type_data.ACCOUNT_TYPE.TOUCH_GOLD)}} title={Dictionary.TOUCHGOLD_BANK} />
                        <AccountTypeButton isActive={!this.state.isIntra} onPress={()=>{this.onChangeAccountType(account_type_data.ACCOUNT_TYPE.OTHERS)}} title={Dictionary.OTHER_BANK}/>
                    </View>
                    <View style={FormStyle.formContainer}>
                        <View style={FormStyle.formItem}>
                            <FloatingLabelInput
                                ...
                                // value={Util.addCommaToDigits(this.state.amount)}
