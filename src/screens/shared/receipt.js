                    ...
                    <ViewShot ref="receiptRef" style={{ backgroundColor: Colors.WHITE }}>
                        ...
                        <View style={styles.body}>
                            ...
                            <View style={styles.container}>
                                ...
                                {!receipt_data_loading && !!status && (
                                    <View style={styles.status}>
                                        <View style={styles.tranxTypeLabelColumn}>
                                            <Text numberOfLines={1} style={styles.label}>{"Status"}</Text>
                                            <View style={[styles.statusPill, {backgroundColor: status === "Paid" || status === "SUCCESS" ? "#38AA43" : "#F9D857"}]}>
                                                <Text numberOfLines={1} style={styles.statusText}>{(status === "Paid" || status === "SUCCESS") && "✓"} {status}</Text>
                                            </View>
                                        </View>
                                    </View>
                                )}
                                ...
                                {hasRecipient && <View style={styles.row}>
                                    <View style={[styles.tranxTypeLabelColumn]}>
                                        <Text numberOfLines={1} style={styles.label}>{Dictionary.BENEFICIARY_NAME_LABEL}</Text>
                                    </View>
                                    <View style={styles.tranxTypeValueColumn}>
                                        <Text numberOfLines={1} style={styles.value}>{transaction_data?.beneficiaryAccountName}</Text>
                                    </View>
                                </View>}
                                {hasRecipient && <View style={styles.row}>
                                    <View style={[styles.tranxTypeLabelColumn]}>
                                    ...
                                    <View style={styles.tranxTypeValueColumn}>
                                        <Text numberOfLines={1} style={styles.value}>{transaction_data?.beneficiaryAccountNumber}</Text>
                                    </View>
                                </View>}
                               ...
                               {receipt_data?.BankName && <View style={styles.row}>
                                    <View style={[styles.tranxTypeLabelColumn]}>
                                        <Text numberOfLines={1} style={styles.label}>{Dictionary.BENEFICIARY_BANK_LABEL}</Text>
                                    </View>
                                    <View style={styles.tranxTypeValueColumn}>
                                        <Text numberOfLines={1} style={styles.value}>{receipt_data?.BankName}</Text>
                                    </View>
                                </View>}
                                <View style={styles.row}>
                                    <View style={[styles.tranxTypeLabelColumn]}>
                                ...
                                <View style={styles.row}>
                                    ...
                                    </View>
                                    {
                                      transaction_payload ? (
                                        <View style={styles.valueColumn}>
                                            <Text numberOfLines={2} style={styles.value}>{transaction_payload?.notes || transaction_payload?.Narration || '- - -'}</Text>
                                        </View>
                                        ) : (
                                        <View style={styles.valueColumn}>
                                ...
                                <View style={[styles.row, transaction_data?.pin ? {} : styles.lastRow]}>
                                    ...
                                    <View style={styles.valueColumn}>
                                        <Text
                                            numberOfLines={2}
                                            style={[styles.value, { ...Typography.FONT_MEDIUM }]}
                                        >
