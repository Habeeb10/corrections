...
class UploadDocument extends Component {
    constructor(props) {
        ...
        header_text = header_text.replace("%s", document.type === "util" || document.type === "utility" 
            ? "utility bill"
    ...
    handleProcessImage = async (imageData) => {
        ...
        if(this.state.document.type === "util" || this.state.document.type === "utility") {
            ...
            <View style={SharedStyle.mainContainer}>
                ...
                <ScrollView {...this.props}>
                    <View style={{ flex: 1 }}>
                        ...
                        {this.state.document.type === 'identity' && !this.state.image_preview && (
