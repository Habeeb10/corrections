        ...
        <ScrollView {...this.props}>
          <View style={FormStyle.formContainer}>
            <View style={styles.center}>
              ...
              <TouchableOpacity style={styles.getHelp} onPress={() => this.props.navigation.navigate("GetHelp")}>
                <Icon.AntDesign name="questioncircleo" size={Mixins.scaleFont(15)} color={Colors.BLACK} />
