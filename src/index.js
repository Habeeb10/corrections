...
import { Keyboard, View , InteractionManager, Linking, Alert, BackHandler} from 'react-native';
...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    this.keyboardDidShowListener = Keyboard.addListener('keyboardDidShow', e => this.handleKeyboardOpened(e));
    this.keyboardDidHideListener = Keyboard.addListener('keyboardDidHide', e => this.handleKeyboardClosed(e));
    this.loadResources(); 
    this.checkVersion();
  }
  ...
  handleKeyboardOpened(e) {
    this.setState({
      ...
      scrollWithTabHeight: Mixins.DRAW_HEIGHT_WITH_NAV - e.endCoordinates.height
    });
  }
        ...
        <View style={SharedStyle.mainContainer}>
          <Provider store={store}>
            <PersistGate loading={null} persistor={persistor}>
              <Navigator screenProps={{ scrollHeight, scrollWithTabHeight }} />
            </PersistGate>
          </Provider>
        </View>
      </MenuProvider>
