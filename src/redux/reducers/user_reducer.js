...
import {
  ...
  SHOW_SESSION_DIALOG,
  HIDE_SESSION_DIALOG,
  START_LOAD_PREFERENCES,
  LOAD_PREFERENCES,
  LOAD_PREFERENCES_FAILED,
  START_LOAD_REFERRAL_ACTIVITIES,
  LOAD_REFERRAL_ACTIVITIES,
  LOAD_REFERRAL_ACTIVITIES_FAILED,
  SHOW_SCREEN_INACTIVITY_DIALOG,
  HIDE_SCREEN_INACTIVITY_DIALOG,
  ADD_REFERAL,
  START_REFERAL_CODE,
  LOAD_REFERAL_CODE,
  START_REFERAL_CODE_FAILED,
  START_LOAD_REFERRAL_ACTIVITIES_RUNNING,
  LOAD_REFERRAL_ACTIVITIES_RUNNING,
  LOAD_REFERRAL_ACTIVITIES_RUNNING_FAILED,
  START_LOAD_REFERRAL_ACTIVITIES_MATURED,
  LOAD_REFERRAL_ACTIVITIES_MATURED,
  LOAD_REFERRAL_ACTIVITIES_MATURED_FAILED,
...
const initialState = {
  ...
  loading_referral_activities_running: false,
  referral_activities_running: {},
  referral_activities_running_error: null,
  loading_referral_activities_matured: false,
  referral_activities_matured: {},
  referral_activities_matured_error: null,
...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case START_LOAD_REFERRAL_ACTIVITIES_RUNNING: {
      return {
        ...state,
        loading_referral_activities_running: true,
        referral_activities_running_error: null,
      };
    }
    case LOAD_REFERRAL_ACTIVITIES_RUNNING: {
      return {
        ...state,
        referral_activities_running: { ...action.referral_activities },
        loading_referral_activities_running: false,
        referral_activities_running_error: null,
      };
    }
    case LOAD_REFERRAL_ACTIVITIES_RUNNING_FAILED: {
      return {
        ...state,
        referral_activities_running: {},
        loading_referral_activities_running: false,
        referral_activities_running_error: action.error_message,
      };
    }
    case START_LOAD_REFERRAL_ACTIVITIES_MATURED: {
      return {
        ...state,
        loading_referral_activities_matured: true,
        referral_activities_matured_error: null,
      };
    }
    case LOAD_REFERRAL_ACTIVITIES_MATURED: {
      return {
        ...state,
        referral_activities_matured: { ...action.referral_activities },
        loading_referral_activities_matured: false,
        referral_activities_matured_error: null,
      };
    }
    case LOAD_REFERRAL_ACTIVITIES_MATURED_FAILED: {
      return {
        ...state,
        referral_activities_matured: {},
        loading_referral_activities_matured: false,
        referral_activities_matured_error: action.error_message,
      };
    }
