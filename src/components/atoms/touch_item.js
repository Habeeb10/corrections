...
import { View, Platform, TouchableNativeFeedback, TouchableOpacity, Keyboard } from 'react-native';
...
export default class TouchItem extends Component {
    ...
    renderAndroid() {
        ...
        return (
            <TouchableNativeFeedback {...this.props} background={feedback} onPress={() => { Keyboard.dismiss(); this.props.onPress(); }}>
                <View {...this.props}>
                    {this.props.children}
                </View>
