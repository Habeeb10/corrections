            ...
            <View style={[styles.background, this.props.backgroundStyle]}>
                {this.props.leftIcon && (
                    <TouchItem
                        ...
                        <Icon.SimpleLineIcons size={Mixins.scaleSize(15)} style={[styles.icon, this.props.textColor ? { color: this.props.textColor } : {}]} name={this.props.leftIcon} />
                    </TouchItem>
                )}
                <Text style={[styles.text, this.props.textColor ? { color: this.props.textColor } : {}]} numberOfLines={1}>{this.props.title}</Text>
                {this.props.rightIcon && (
                    <TouchItem disabled={!this.props.onPressRightIcon}
                        style={styles.rightIcon}
                        onPress={this.props.onPressRightIcon}>
                        <Icon.SimpleLineIcons size={Mixins.scaleSize(15)} style={[styles.icon, this.props.textColor ? { color: this.props.textColor } : {}]} name={this.props.rightIcon} />
                    </TouchItem>
                )}
            </View>
        );
