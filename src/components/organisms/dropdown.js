...
class Dropdown extends Component {
  ...
  render() {
    let optionItems = [];
    let options = this.state.searchTerm
    ...
    if (this.props.value.label) {
      ...
      textColor = this.props.placeholderColor
      ...
      if (this.props.textStyle) {
        textColor = this.props.textStyle.color
    ...
    if (!!this.props.value.hardCodedImage) {
      if (!!this.props.value.bankImage) {
        icon =
          banks[this.props.value.imageUrl] ||
          banks[this.props.value.defaultImg];
      }
    } else {
          ...
          >
            ...
            >
              <View style={{}}>
                ...
                <View
                  style={{ ...Mixins.padding(20, 20, 0, 20), width: "100%" }}
                >
                  <TextInput
                    style={[styles.search]}
              ...
              {!!this.props.loading && (
                <Text style={[styles.otherTitle, { paddingLeft: 20 }]}>
                  Loading..
                </Text>
              )}
              {this.props.options.length === 0 && !this.props.loading && (
                <Text style={[styles.otherTitle, { paddingLeft: 20 }]}>
                  {this.props.emptyListMessage || "No Items"}
                </Text>
              )}
              <ScrollView
                style={{
